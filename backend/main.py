...
import json
import os
from typing import Dict, Any # Add to existing imports
...
class MarketSentiment(BaseModel):
    ...
    market_consensus: str  # BUY / SELL / HOLD
    summary: str
    last_updated: str
    # Optional: detailed news list if you want to show it
    news_analysis: Optional[List[Dict[str, Any]]] = None

# --- HELPER: Read the Shared Cache (Layer 3) ---
CACHE_FILE = "market_news_cache.json"
